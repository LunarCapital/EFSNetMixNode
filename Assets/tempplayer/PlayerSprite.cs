...
{
    private static Texture2D _stand = ResourceLoader.Load<Texture2D>("res://assets/tempplayer/textures/stand.png");
    private static Texture2D _jump = ResourceLoader.Load<Texture2D>("res://assets/tempplayer/textures/jump.png");
    private static Texture2D _run = ResourceLoader.Load<Texture2D>("res://assets/tempplayer/textures/run.png");
    ...
    public override void _Ready()
    {
        ...
        _parentMath = (PlayerMath25D)_parent.GetChild<CharacterBody3D>(0);
    }
